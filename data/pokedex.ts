export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	persian: {
		...
		name: "Persian",
		types: ["Normal"],
		baseStats: {hp: 65, atk: 80, def: 60, spa: 55, spd: 65, spe: 115},
	...
	golduck: {
		...
		abilities: {0: "Damp", 1: "Cloud Nine", H: "Neuroforce"},
		heightm: 1.7,
		weightkg: 76.6,
		color: "Blue",
		prevo: "Psyduck",
	...
	tentacruel: {
		...
		name: "Tentacruel",
		types: ["Water", "Poison"],
		baseStats: {hp: 80, atk: 60, def: 65, spa: 90, spd: 120, spe: 100},
		abilities: {0: "Clear Body", 1: "Liquid Ooze", H: "Rain Dish"},
		heightm: 1.6,
		weightkg: 55,
		color: "Blue",
	...
	rapidash: {
		...
		abilities: {0: "Reckless", 1: "Flash Fire", H: "Flaming Soul"},
		heightm: 1.7,
		weightkg: 95,
		color: "Yellow",
		prevo: "Ponyta",
	...
	dewgong: {
		...
		name: "Dewgong",
		types: ["Water", "Ice"],
		baseStats: {hp: 95, atk: 50, def: 80, spa: 90, spd: 95, spe: 70},
	...
	kabutops: {
		...
		abilities: {0: "Blademaster", H: "Switf Swim"},
		heightm: 1.3,
		weightkg: 40.5,
		color: "Brown",
		prevo: "Kabuto",
